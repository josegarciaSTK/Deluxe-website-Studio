          ...
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-lg text-zinc-600 font-manrope leading-relaxed">
                <p>
                  Founded over 15 years ago, DLX Renovations began with a simple mission: to elevate the standard of construction through meticulous attention to detail and unwavering integrity.
                </p>
                <p>
                  Our journey has taken us from high-end custom home builds to massive commercial rehabilitations—including 150-room hotel renovations and 45,000-square-foot hospitality environments.
                </p>
              </div>
            </motion.div>
          </div>
